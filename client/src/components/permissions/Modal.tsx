...
interface ModalProps {
  ...
  danger?: boolean;            // header accent for "delete"
  initialFocusId?: string;     // element id to focus on open
}
  ...
  return (
    ...
    >
      ...
      <div
        ref={panelRef}
        tabIndex={-1}
        className={`relative w-full ${sizeClass[size]} mx-auto bg-white rounded-2xl shadow-xl ring-1 ring-black/5 animate-[fadeIn_160ms_ease-out]`}
